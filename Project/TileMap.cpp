...
void TileMap::InitTileDictionary()
{
	...
	dict_tiles[(int)Tile::WALL_OUTSIDE_C_DOWN_LEFT] = { n * 3, n * 3, n, n };
	...
	dict_tiles[(int)Tile::DOBLE_CURVED_OC_UP_LEFT] = { 8 * n, 0, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_UP_LEFT] = { 9 * n, 0, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_UP_RIGHT] = { 10 * n, 0, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_OC_UP_RIGHT] = { 11 * n, 0, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_LEFT_UP] = { 8 * n, n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_IC_UP_LEFT] = { 9 * n, n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_IC_UP_RIGHT] = { 10 * n, n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_RIGHT_UP] = { 11 * n, n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_LEFT_DOWN] = { 8 * n, 2 * n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_IC_DOWN_LEFT] = { 9 * n, 2 * n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_IC_DOWN_RIGHT] = { 10 * n, 2 * n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_RIGHT_DOWN] = { 11 * n, 2 * n, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_OC_DOWN_LEFT] = { 8 * n, n * 3, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_DOWN_LEFT] = { 9 * n, n * 3, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_DOWN_RIGHT] = { 10 * n, n * 3, n, n };
	dict_tiles[(int)Tile::DOBLE_CURVED_OC_DOWN_RIGHT] = { 11 * n, n * 3, n, n };
...
AppStatus TileMap::Initialise()
{
	...
	if (data.LoadTexture(ResourceType::IMG_MAP, "images/tileset.png") != AppStatus::OK)
	{
